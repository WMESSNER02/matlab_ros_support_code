...
%Part 1: Moving robot to above the Can
%This allows the robot to move to a location above the Can without
%interfeering with the other objects in the world.
...
%A pause is added to ensure the robot stopped at the waypoint above the can
%This is to also be able to visually confirm the end effector did reached
%the desired point.
pause(2)

%Part 2: Lower the gripper to the can
%This part repeats the same process as in Part 1. 
...
EndEffectorPose2 = [gripperX, gripperY, gripperZ, gripperRotation(1,1), gripperRotation(1,2), gripperRotation(1,3)]
