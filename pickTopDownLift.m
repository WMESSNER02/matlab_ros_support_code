...
%The Script uses pickTopDownCan to move to the Can and grasp the can 
%   - pickTopDownCan moves to the can using the moveTopDownCan script
%   - This script includes a reset of the world and a return of the robot to
%   home configuration

pickTopDownCan

%The pause allows for the can to settle once the gripper closes 
pause(2)

%Once robot has grasped the can, a comand is created to raise the can. 

%NOTE: This part of the code is obsolete because the moveTopDownCan script
%already initialize the client, server and messages.
...
EndEffectorPose4 = [gripperX, gripperY, gripperZ, gripperRotation(1,1), gripperRotation(1,2), gripperRotation(1,3)]
